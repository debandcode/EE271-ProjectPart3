...
# DVE full session
# Saved on Mon Nov 17 12:14:31 2025
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 174} {height 754} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 174} {height 754} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_sg_addsignal -group "$_session_group_1" { tb_top.rst_n }

set _session_group_2 Group2
gui_sg_create "$_session_group_2"
set Group2 "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { tb_top.simulation_complete tb_top.instruction_count }

set _session_group_3 Group3
gui_sg_create "$_session_group_3"
set Group3 "$_session_group_3"

gui_sg_addsignal -group "$_session_group_3" { tb_top.instruction_count }
...
gui_open_source -id ${Source.1} ../unoptimized_verilog/logical/buffer.sv -startline 13 -replace
